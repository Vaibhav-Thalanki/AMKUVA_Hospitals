...
$query = "UPDATE doctor SET `dname` = '$dname', `department`='$dept', `degree`='$deg', `date`=current_timestamp() where did=$did";
       ...
       <section class="timeliner timeline-container">
         <div class="timeline-block">
          ...
          <div class="timeline-content">
            <h2>
             <div class="text-center"><label for="did" style="font-size:28px">Old Doctor ID:</label></div>
            </h2>
        ...
        <div class="timeline-block clearfix">
          ...
          <div class="timeline-content">
            <h2>
             <div class="text-center"><label for="dname" style="font-size:28px">New Doctor Name:</label></div>
            </h2>
        ...
        <div class="timeline-block clearfix">
          ...
          <div class="timeline-content">
            <h2>
             <div class="text-center"><label for="dept" style="font-size:28px">New Department:</label></div>
            </h2>
        ...
        <div class="timeline-block clearfix">
          ...
          <div class="timeline-content">
            <h2>
             <div class="text-center"><label for="deg" style="font-size:28px">New Degree:</label></div>
            </h2>
