...
$query = "SELECT labno, did, pid from labreport where labno=$lno";
$result = mysqli_query($conn,$query);
while($row = mysqli_fetch_array($result)){
echo "<B>Lab No. :</B>".$row['labno'] ; echo"<br>";
    ...
    <div class="section-wrapper" id="details">
      <div class="section-title m-top-100 text-center">
       <p>_</p>
        ...
        <div class="sub-title">Enter Lab No. to view records!!</div>  
      </div>
      <form action="labreportview.php" method="post">
